<template>
  ...
  >
    <div class="container">
      <div class="row">
        <card class="card-signup" header-classes="text-center" color="yellow">
          <template slot="header">
            <h3 class="card-title title-up">Parent</h3>
          ...
          <div class="card-footer text-center">
            <n-button type="neutral" round size="lg">Sign Up</n-button>
          </div>
        </card>
        <card class="card-signup" header-classes="text-center" color="yellow">
          <template slot="header">
            <h3 class="card-title title-up">Driver</h3>
            <div class="social-line">
              <a
                href="#pablo"
                class="btn btn-neutral btn-facebook btn-icon btn-round"
